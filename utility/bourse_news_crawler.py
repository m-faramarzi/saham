...
class BourseNewsCrawler(BaseCrawler):
    ...
    # ---------------- category ----------------
        ...
        if tag:
            ...
            news_item.category = category.replace("\u200c", "").replace("\u200f", "").strip()
    ...
    # ---------------- dates ----------------
        ...
        news_item.publish_date_j, news_item.publish_date_g = JalaliDateParser.parse(date_text,"DD MONTH YYYY - HH24:MI")
